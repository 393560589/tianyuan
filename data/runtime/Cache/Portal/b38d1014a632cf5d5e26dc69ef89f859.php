...
<div class="indexBoxTwo">
	...
	<div class="indexBoxThree">
		...
		<!--sp_sql_posts函数用于获取文章列表，并能进入相应的文章页面样式-->
	<!-- <?php $company_news=sp_sql_posts("cid:7;field:post_title,post_excerpt,tid,smeta,post_modified;order:post_modified desc;limit:5;"); $hangye_domain=sp_sql_posts("cid:8;field:post_title,post_excerpt,tid,smeta,post_modified;order:post_modified desc;limit:5"); ?> -->
	<!-- <div class="row">
		<?php if(is_array($company_news)): foreach($company_news as $key=>$vo): $smeta=json_decode($vo['smeta'],true); ?>
		<div class="span3">
			<div class="tc-gridbox">
				<div class="header">
					<div class="item-image">
						<a href="<?php echo leuu('portal/article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>">
							<?php if(empty($smeta['thumb'])): ?><img src="/thinkcmf/themes/simplebootx/Public/images/default_tupian1.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
							<?php else: ?> 
					...
					<h3><a href="<?php echo leuu('portal/article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>"><?php echo ($vo["post_title"]); ?></a></h3>
					<hr>
				</div>
				<div class="body">
					<p><a href="<?php echo leuu('portal/article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>"><?php echo msubstr($vo['post_excerpt'],0,32);?></a></p>
				</div>
			</div>
		</div><?php endforeach; endif; ?>
	</div> -->
