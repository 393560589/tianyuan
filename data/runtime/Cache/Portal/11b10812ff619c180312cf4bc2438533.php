...
<hr>
 ...
 <?php $at=sp_sql_posts('cid:7;field:post_title,post_modified,post_content,tid,smeta,post_excerpt;order:post_modified desc;'); ?>
  ...
  <img src="/thinkcmf/themes/simplebootx/Public/images/2.png" alt="">
                                <a href="<?php echo leuu('portal/article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>" target='_blank'><?php echo ($vo["post_title"]); ?></a>
                            </div>
